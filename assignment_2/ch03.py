...
Original file is located at
    https://colab.research.google.com/drive/1R9_BtndIAeo2MdAFBj8YmG5gLoBi03wG
"""
...
def plot_decision_regions(X, y, classifier, test_idx=None, resolution=0.02):
    ...
    cmap = ListedColormap(colors[:len(np.unique(y))]) # Now ListedColormap is accessible here
...
class LogisticRegressionGD:
    ...
    def fit(self, X, y):
        ...
        for i in range(self.n_iter):
            net_input = self.net_input(X) # Now self.net_input is accessible
        ...
        return self # Moved return self outside the for loop to complete all iterations
    ...
    def predict(self, X):
        ...
        return np.where(self.activation(self.net_input(X)) >= 0.5, 1, 0) # Now self.net_input and self.activation are accessible
